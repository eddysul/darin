-- B0.4c rollout bridge: expose proof-bound registration before the mobile
-- update. Keep existing tokens, direct-write policies, and dispatch behavior
-- unchanged until the final 202609160001 security migration is applied.
