...
const excluded = new Set(["i18n.ts", "i18nCoreMessages.ts", "i18nRecordDetailMessages.ts", "i18nDiaryCriticalMessages.ts", "i18nSettingsCriticalMessages.ts", "i18nGrowthCriticalMessages.ts", "i18nReportCriticalMessages.ts", "i18nConsultCriticalMessages.ts", "i18nFamilyCriticalMessages.ts", "i18nMemoriesCriticalMessages.ts", "i18nStickerCriticalMessages.ts", "i18nNoticeCriticalMessages.ts", "i18nPickerCriticalMessages.ts", "i18nInsightCriticalMessages.ts", "i18nChromeCriticalMessages.ts", "i18nQaCriticalMessages.ts", "i18nContractionCriticalMessages.ts"]);
const korean = /[가-힣]/;
