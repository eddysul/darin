...
console.log(JSON.stringify({ target, projectRef, execute, identity, version, sha256, pending, preflight }));
...
if (post.history !== 1 || !post.register || !post.unregister || !post.claim
