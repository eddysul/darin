...
export const DEMO_INCOMING_REQUESTS: IncomingRequest[] = [
  ...
  },
  {
    ...
    contractFields: {
      ...
      weeklyPay: "$1,800/wk",
      liveIn: true,
      workHours: "Live-in · 24/5",
      specialTerms: "Breastfeeding support required. Korean preferred.",
    },
    parentSignature: "Jisoo Kim",
    parentSignedAt: new Date(Date.now() - 7200 * 1000).toISOString(),
    caregiverSignature: "Ji-yeon Park",
    caregiverSignedAt: new Date(Date.now() - 3600 * 1000).toISOString(),
  },
];
