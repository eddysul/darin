...
const styles = StyleSheet.create({
  ...
  errorBox: { backgroundColor: colors.cardHi, borderColor: colors.brandCoralSoft },
  ...
  bannerText: { flex: 1, color: colors.dangerText, fontSize: 12.5, lineHeight: 18, fontWeight: "600" },
  bannerAction: { paddingHorizontal: 8, paddingVertical: 5 },
  bannerActionText: { color: colors.dangerText, fontSize: 12, fontWeight: "800" },
  bannerClose: { color: colors.muted, fontSize: 14, fontWeight: "700" },
});
