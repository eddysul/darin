...
const styles = StyleSheet.create({
  ...
  newIngredientSave: { minWidth: 58, minHeight: 44, borderRadius: 12, backgroundColor: colors.primary, alignItems: "center", justifyContent: "center" },
  newIngredientSaveText: { color: colors.primaryForeground, fontSize: 13, fontWeight: "800" },
