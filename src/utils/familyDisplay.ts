...
const ERROR_KEYS: Record<string, MessageKey> = {
  ...
  VIDEO_TOO_LONG: "memory.critical.190",
  VIDEO_TOO_LARGE: "memory.critical.201",
  VIDEO_DURATION_UNKNOWN: "memory.critical.206",
  IMAGE_TOO_LARGE: "memory.critical.115",
  READ_FAILED: "chrome.critical.108",
