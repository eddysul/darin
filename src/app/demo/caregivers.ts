...
export const CAREGIVER_MATCHES: CaregiverMatch[] = [
  {
    ...
    careStyleEn:
      "Gentle, routine-focused care with warm communication. Uses play-based learning and consistent nap transitions.",
    careStyleKo:
      "부드럽고 일과 중심의 돌봄과 따뜻한 소통. 놀이 기반 학습과 일관된 낮잠 전환을 사용합니다.",
    credentials: [
  ...
  },
  {
    ...
    careStyleEn:
      "Creative and energetic with art, music, and outdoor activities. Keeps parents updated with photo notes.",
    careStyleKo:
      "미술, 음악, 야외 활동으로 창의적이고 활기찬 돌봄. 사진 메모로 부모에게 업데이트합니다.",
    credentials: [
      { id: "identity", status: "verified" },
      { id: "cpr", status: "verified" },
  ...
  },
  {
    ...
    careStyleEn:
      "Structured Montessori-inspired routines with calm transitions and developmental focus.",
    careStyleKo:
      "차분한 전환과 발달 중심의 체계적인 몬테소리 스타일 일과.",
    credentials: [
      { id: "identity", status: "verified" },
      { id: "cpr", status: "verified" },
      { id: "license", status: "verified" },
